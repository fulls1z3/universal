...
import { CoreTestingModule, MockWindowFrench, MockWindowNoLanguage } from '../core/testing';
...
describe('I18NService', () => {
  ...
  test(
    ...
    inject([I18NService], (instance: I18NService) => {
...
describe('I18NService for `fr` browser', () => {
  ...
  test(
    ...
    inject([WindowService], (win: WindowService) => {
  ...
  test(
    ...
    inject([I18NService, WindowService], (i18n: I18NService) => {
      const actual = i18n.getLanguageCodeFromBrowser();
