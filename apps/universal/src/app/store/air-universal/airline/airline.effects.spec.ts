...
describe('AirlineEffects', () => {
  ...
  test(
    ...
    inject([AirlineEffects], (effects: AirlineEffects) => {
  ...
  describe('getMany$', () => {
    ...
    test(
      ...
      inject([AirlineEffects, AirlineService], (effects: AirlineEffects, airline: MockAirlineService) => {
  ...
  describe('createOne$', () => {
    test(
      ...
      inject([Router, AirlineEffects], (router: Router, effects: AirlineEffects) => {
    ...
    test(
      ...
      inject([Router, AirlineEffects, AirlineService], (router: Router, effects: AirlineEffects, airline: MockAirlineService) => {
        airline.isFailing = true;
